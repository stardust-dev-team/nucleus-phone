    ...
    <div
      ...
      style={{
        ...
        animation: active && connected && !detected
          ...
          : 'none',
        boxShadow: detected
          ? '0 0 20px 2px var(--cockpit-live-glow)'
          : active
            ? '0 0 8px 0 var(--cockpit-live-glow)'
            : 'none',
      }}
    >
      {/* Header — bold, full-width banner */}
      <div
      ...
      >
        ...
        <span
          ...
          style={{
            color: detected ? '#FFFFFF' : 'var(--cockpit-live-900)',
          }}
        >
          {!detected
        ...
        {/* Equipment count pill (when detected) */}
        {sizing && (
          <span
