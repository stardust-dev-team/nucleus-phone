...
// transcription-stopped event in transcription.js. Auth is the Twilio
// signature (twilioWebhook). Distinct from /api/recording (signed-URL +
// stream proxy for client playback) — split in nucleus-phone-op7.
